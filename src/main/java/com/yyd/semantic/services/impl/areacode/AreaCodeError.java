...
public class AreaCodeError {
	public static Integer ERROR_SUCCESS = 0;
	public static Integer ERROR_NO_RESOURCE = 1301;	
	public static Integer ERROR_UNKNOW_INTENT = 1302;
	public static Integer ERROR_REGION_NAME_ERROR = 1303;
	public static Integer ERROR_NO_SLOG_DATA = 1304;
