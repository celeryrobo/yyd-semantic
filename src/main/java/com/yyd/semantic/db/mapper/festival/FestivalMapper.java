...
public interface FestivalMapper {
	...
	@Results({ @Result(property = "id", column = "id"), @Result(property = "name", column = "name"),
			@Result(property = "enDate", column = "en_date"), @Result(property = "cnDate", column = "cn_date"),
			@Result(property = "dateCode", column = "date_code"), @Result(property = "enName", column = "en_name") })
